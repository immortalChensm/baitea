<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:42:"./application/admin/view2/store\score.html";i:1517208468;s:44:"./application/admin/view2/public\layout.html";i:1517208468;}*/ ?>
<!doctype html>
<html>
<head>
	...
	<div class="fixed-bar">
		<div class="item-title">
			...
			<ul class="tab-base nc-row">
	        	<li><a href="<?php echo U('Store/satisfaction'); ?>">店铺满意度</a></li>
	       	 	<li><a href="<?php echo U('Store/score'); ?>"  class="current">店铺评分</a></li>
	      	</ul>
		</div>
	</div>
	<!-- 操作说明 -->
	...
	<div class="flexigrid">
		<div class="mDiv">
			...
			<div title="刷新数据" class="pReload"><i class="fa fa-refresh"></i></div>
                        <!--临时屏蔽 9/22 15:25-->
<!--			<form class="navbar-form form-inline" id="search-form" action="<?php echo U('Store/score'); ?>" method="get">
				<div class="sDiv">
					<div class="sDiv2">
				...
				<table>
					...
					<?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): if( count($list)==0 ) : echo "" ;else: foreach($list as $k=>$vo): ?>
						<tr>
							...
							<td align="left" class="">
								<div style="text-align: left; width: 120px;"><?php echo $vo['store_id']; ?></div>
							</td>
							<td align="left" class="">
								<div style="text-align: left; width: 200px;"><?php echo $vo['store_name']; ?></div>
							</td>
							<td align="left" class="">
								<div style="text-align: center; width: 100px;"><?php echo round($vo['describe_score'],2); ?></div>
							</td>
							<td align="center" class="">
								<div style="text-align: center; width: 100px;"><?php echo round($vo['seller_score'],2); ?></div>
							</td>
							<td align="center" class="">
								<div style="text-align: center; width: 100px;"><?php echo round($vo['logistics_score'],2); ?></div>
							</td>
							<td align="center" class="">
