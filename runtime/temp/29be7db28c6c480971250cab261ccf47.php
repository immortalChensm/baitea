<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:56:"./application/admin/view2/finance\store_withdrawals.html";i:1517208468;s:44:"./application/admin/view2/public\layout.html";i:1517208468;}*/ ?>
<!doctype html>
<html>
<head>
                ...
                <div class="sDiv">
                    ...
                    <div class="sDiv2" style="margin-right: 10px;border: none;">
                        <select id="status" name="status" class="form-control">
                            ...
                            <option value="-1" <?php if($_REQUEST['status'] == -1): ?>selected<?php endif; ?>>申请失败</option>
