<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:49:"./application/seller/new/goods\ajaxGoodsList.html";i:1517208469;}*/ ?>
<table class="ncsc-default-table" data-goods-examine="<?php echo $store['goods_examine']; ?>">
    ...
    <?php else: if(is_array($goodsList) || $goodsList instanceof \think\Collection || $goodsList instanceof \think\Paginator): $i = 0; $__LIST__ = $goodsList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$list): $mod = ($i % 2 );++$i;?>
        <tr class="bd-line" data-goods-id="<?php echo $list['goods_id']; ?>">
            ...
            <td><img width="20" height="20" src="__PUBLIC__/images/yes.png" class="is_on_sale"/></td>
            <td>
                <?php if($list['is_new'] == 1): ?>
                    <img width="20" height="20" src="__PUBLIC__/images/yes.png" onclick="changeTableVal2('goods','goods_id',<?php echo $list[goods_id]; ?>,'is_new',this)"/>
                <?php else: ?>
            ...
            <td>
                <?php if($list['is_hot'] == 1): ?>
                    <img width="20" height="20" src="__PUBLIC__/images/yes.png" onclick="changeTableVal2('goods','goods_id',<?php echo $list[goods_id]; ?>,'is_hot',this)"/>
                <?php else: ?>
            ...
            <td>
                <?php if($list['is_recommend'] == 1): ?>
                    <img width="20" height="20" src="__PUBLIC__/images/yes.png" onclick="changeTableVal2('goods','goods_id',<?php echo $list[goods_id]; ?>,'is_recommend',this)"/>
                <?php else: ?>
