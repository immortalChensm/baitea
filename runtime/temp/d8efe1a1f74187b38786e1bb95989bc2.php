<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:46:"./application/admin/view2/system\shopping.html";i:1517208469;s:44:"./application/admin/view2/public\layout.html";i:1517208468;}*/ ?>
<!doctype html>
<html>
<head>
            ...
            <dl class="row">
                ...
                <dd class="opt">
                    <select name="auto_confirm_date" id="distribut_date">
                        <?php $__FOR_START_1993__=1;$__FOR_END_1993__=31;for($i=$__FOR_START_1993__;$i < $__FOR_END_1993__;$i+=1){ ?>
            ...
            <dl class="row">
                ...
                <dd class="opt">
                    <select  name="auto_transfer_date" id="auto_transfer_date">
                        <?php $__FOR_START_15312__=1;$__FOR_END_15312__=31;for($i=$__FOR_START_15312__;$i < $__FOR_END_15312__;$i+=1){ ?>
            ...
            <dl class="row">
                ...
                <dd class="opt">
                    <select name="auto_service_date" id="auto_service_date">
                        <?php $__FOR_START_12179__=1;$__FOR_END_12179__=31;for($i=$__FOR_START_12179__;$i < $__FOR_END_12179__;$i+=1){ ?>
