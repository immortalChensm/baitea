<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:51:"./application/admin/view2/store\store_own_list.html";i:1522053715;s:44:"./application/admin/view2/public\layout.html";i:1517208468;}*/ ?>
<!doctype html>
<html>
<head>
	...
	<div id="explanation" class="explanation" style="color: rgb(44, 188, 163); background-color: rgb(237, 251, 248); width: 99%; height: 100%;">
		...
		<ul>
			...
			<li>2. 可以设置未绑定全部商品类目的平台自营店铺的经营类目。</li>
			  -->
			<li>2. 已经发布商品的自营店铺不能被删除。</li>
			<li>3. 删除平台自营店铺将会同时删除店铺的相关图片以及相关商家中心账户，请谨慎操作！</li>
		</ul>
	</div>
	<div class="flexigrid">
		<div class="mDiv">
