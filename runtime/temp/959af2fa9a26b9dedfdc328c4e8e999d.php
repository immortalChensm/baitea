<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:45:"./application/admin/view2/report\finance.html";i:1517208468;s:44:"./application/admin/view2/public\layout.html";i:1517208468;}*/ ?>
<!doctype html>
<html>
<head>
						...
						<tr>
							...
							<td align="center" class="handle">
								<div style="text-align: center; width: 170px; max-width:170px;">
									<a href="<?php echo U('Report/financeDetail',array('start_time'=>$vo['day'],'end_time'=>$vo['end'])); ?>" class="btn blue"><i class="fa fa-search"></i>查看详细列表</a>
								</div>
							</td>
