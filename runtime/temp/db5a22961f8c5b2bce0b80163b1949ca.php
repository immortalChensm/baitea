<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:51:"./application/seller/new/service\ajax_ask_list.html";i:1517208469;}*/ ?>
    ...
    <table class="ncsc-default-table">
        ...
        <?php if(count($comment_list) > 0): if(is_array($comment_list) || $comment_list instanceof \think\Collection || $comment_list instanceof \think\Paginator): $i = 0; $__LIST__ = $comment_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$list): $mod = ($i % 2 );++$i;?>
            <tr>
                ...
                <td><img width="20" height="20" src="__PUBLIC__/images/<?php if($list[is_show] == 1): ?>yes.png<?php else: ?>cancel.png<?php endif; ?>" onclick="changeTableVal2('goods_consult','id','<?php echo $list['id']; ?>','is_show',this)"/></td>
