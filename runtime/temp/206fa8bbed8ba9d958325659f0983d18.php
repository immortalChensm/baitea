<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:50:"./application/admin/view2/service\return_list.html";i:1517208468;s:44:"./application/admin/view2/public\layout.html";i:1517208468;}*/ ?>
<!doctype html>
<html>
<head>
		        ...
		        <td align="center" abbr="article_show" axis="col5" class="">
		          <div style="text-align: center;width: 60px;" class="">
                    ...
                    <?php else: $imgs = explode(',',$vo[imgs]);if(is_array($imgs) || $imgs instanceof \think\Collection || $imgs instanceof \think\Paginator): if( count($imgs)==0 ) : echo "" ;else: foreach($imgs as $key=>$img): ?>
						   <!-- <a href="<?php echo $img; ?>" onmouseover="layer.tips('<img src=<?php echo $img; ?>>',this,{tips: [1, '#fff']});" onmouseout="layer.closeAll();" target="_blank" class="pic-thumb-tip"><i class="fa fa-picture-o"></i></a>-->
