<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:49:"./application/seller/new/service\return_list.html";i:1517208469;s:41:"./application/seller/new/public\head.html";i:1522050654;s:41:"./application/seller/new/public\left.html";i:1517208469;s:41:"./application/seller/new/public\foot.html";i:1517208469;}*/ ?>
<!doctype html>
<html>
<head>
<meta charset="utf-8">
   ...
   <div id="sidebar" class="sidebar">
    ...
    <div id="layoutRight" class="ncsc-layout-right">
        ...
        <div class="main-content" id="mainContent">
            <div class="tabmenu">
                <ul class="tab pngFix">
                	<li class=""><a href="<?php echo U('Service/refund_list'); ?>">退货退款</a></li>
                    <li class="active"><a href="<?php echo U('Service/return_list'); ?>">换货维修</a></li>
                </ul>
            </div>
				...
				<table class="ncsc-default-table">
				    ...
				    <?php if(count($list) > 0): if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$items): $mod = ($i % 2 );++$i;?>
				        <tr class="bd-line">
				            ...
				            <td><?php echo getSubstr($goods_list[$items['goods_id']],0,25); ?>*<?php echo $items['goods_num']; ?></td>
				            <td>
				                <?php if($items[type] == 2): ?>换货<?php endif; if($items[type] == 3): ?>维修<?php endif; ?>
				            </td>
				            <td class=""><?php echo date('Y-m-d H:i',$items['addtime']); ?></td>
				            <td class=""><?php echo $state[$items[status]]; ?></td>
				            <td class="nscs-table-handle">
			                    <span>
			                        <a href="<?php echo U('Service/return_info',array('id'=>$items['id'])); ?>" class="btn-bluejeans">
			                        <?php if(($items[status] == 0) OR ($items[status] == 3)): ?><i class="icon-edit"></i><p>处理</p><?php else: ?><i class="icon-eye-open"></i><p>查看</p><?php endif; ?>
			                        </a>
			                    </span>
