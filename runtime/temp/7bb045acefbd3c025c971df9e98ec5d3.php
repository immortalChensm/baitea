<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:49:"./application/admin/view2/coupon\coupon_list.html";i:1517208468;s:44:"./application/admin/view2/public\layout.html";i:1517208468;}*/ ?>
<!doctype html>
<html>
<head>
					...
					<tbody>
					 <?php if(is_array($lists) || $lists instanceof \think\Collection || $lists instanceof \think\Paginator): $i = 0; $__LIST__ = $lists;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$list): $mod = ($i % 2 );++$i;?>
						<tr>
							...
							<td align="left" class="">
								<div style="text-align: left; width: 240px;"><?php echo $list['send_time']; ?></div>
							</td>
							<td align="left" class="">
								<div style="text-align: center; width: 80px;"><?php echo $coupon_type[$list[type]]; ?></div>
							</td>
							<td align="left" class="">
								<div style="text-align: center; width: 120px;"><?php echo (isset($list['order_sn']) && ($list['order_sn'] !== '')?$list['order_sn']:'无'); ?></div>
							</td>
							<td align="left" class="">
								<div style="text-align: center; width: 120px;"><?php echo (isset($list['nickname']) && ($list['nickname'] !== '')?$list['nickname']:'无昵称'); ?></div>
							</td>
							<td align="left" class="">
								<div style="text-align: center; width: 120px;">
                                  <?php if($list[use_time] > 0): ?><?php echo date('Y-m-d H:i',$list['use_time']); else: ?>N<?php endif; ?>
                                </div>
							</td>
							<?php if(($type == 3)): ?>
							<td align="left" class="">
							...
							<?php endif; ?>
							<td align="left" class="">
								<div style="text-align: center; width: 80px;"><?php if($list['status'] == 0): ?>未使用<?php elseif($list['status'] == 1): ?>已使用<?php else: ?>已过期<?php endif; ?></div>
							</td>
							<td align="center" class="handle">
								<div style="text-align: center; width: 170px; max-width:170px;">
									<a href="<?php echo U('Admin/Coupon/coupon_list_del',array('id'=>$list['id'])); ?>" id="button-delete6"  class="btn red" data-original-title="删除"><i class="fa fa-trash-o"></i></a>
								</div>
							</td>
