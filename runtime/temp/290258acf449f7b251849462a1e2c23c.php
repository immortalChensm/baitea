<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:44:"./application/admin/view2/index\welcome.html";i:1517208468;}*/ ?>
<html>
<head>
                    ...
                    <div class="sc_warp" style="padding-bottom: 30px;">
                        <table cellpadding="0" cellspacing="0" class="system_table">
                            <tbody><tr>
                                ...
                                <td><?php echo $sys_info['version']; ?></td>
                            ...
                            <tr>
                                ...
                                <td><a href="http://shopb2b2c.mppstore.com" target="_blank">商业授权</a></td>
                                <td class="gray_bg"></td>
...
<div id="footer" style="position: static; bottom: 0px; font-size:14px;">
    <p><b> 版权所有 © 2012-2017 苏州掌心网络科技有限公司</b></p>
</div>
