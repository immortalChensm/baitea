<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:48:"./application/seller/new/coupon\coupon_list.html";i:1523604261;s:41:"./application/seller/new/public\head.html";i:1522050654;s:41:"./application/seller/new/public\left.html";i:1517208469;s:41:"./application/seller/new/public\foot.html";i:1517208469;}*/ ?>
<!doctype html>
<html>
<head>
<meta charset="utf-8">
   ...
   <div id="sidebar" class="sidebar">
    ...
    <div id="layoutRight" class="ncsc-layout-right">
        ...
        <div class="main-content" id="mainContent">
            <div class="tabmenu">
                <ul class="tab pngFix">
                    <li class="active"><a href="<?php echo U('coupon/coupon_list'); ?>">发放代金券列表</a></li>
                </ul>
            ...
            <table class="ncsc-default-table">
                ...
                <?php if(is_array($lists) || $lists instanceof \think\Collection || $lists instanceof \think\Paginator): $i = 0; $__LIST__ = $lists;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$list): $mod = ($i % 2 );++$i;?>
                    <tr class="bd-line">
                        ...
                        <td>
                            <?php if($list[use_time] > 0): ?>
                                <?php echo date('Y-m-d H:i',$list['use_time']); else: ?>
                                N
                            <?php endif; ?>
                        </td>
                        <?php if(($list[type] == 3) and ($list[code] != '')): ?>
                            <td>
                                <?php echo $list['code']; ?>
                            </td>
                        <?php endif; ?>
                        <td class="nscs-table-handle">
                            <span><a data-url="<?php echo U('Coupon/coupon_list_del',array('id'=>$list['id'])); ?>" class="btn-grapefruit" onclick="delfun(this,<?php echo $list['id']; ?>)"><i class="icon-trash"></i><p>删除</p></a></span>
                        </td>
                    </tr>
                <?php endforeach; endif; else: echo "" ;endif; ?>
                </tbody>
