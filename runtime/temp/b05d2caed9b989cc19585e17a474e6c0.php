<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:45:"./application/seller/new/report\saleList.html";i:1517208469;s:41:"./application/seller/new/public\head.html";i:1522050654;s:41:"./application/seller/new/public\left.html";i:1517208469;s:41:"./application/seller/new/public\foot.html";i:1517208469;}*/ ?>
<!doctype html>
<html>
<head>
<meta charset="utf-8">
   ...
   <div id="sidebar" class="sidebar">
	...
	<div id="layoutRight" class="ncsc-layout-right">
		...
		<div class="main-content" id="mainContent">
			<div class="tabmenu">
				<ul class="tab pngFix">
					<li class="active"><a href="<?php echo U('Report/saleList'); ?>">店铺概况</a></li>
				</ul>
			</div>
			<table class="search-form">
				<form method="get" action="<?php echo U('Report/saleList'); ?>" id="search-form2" onsubmit="check_form();">			
					<tr>
						<td>&nbsp;</td>
