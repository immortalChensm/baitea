<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:46:"./application/seller/new/store\store_info.html";i:1522052237;s:41:"./application/seller/new/public\head.html";i:1528699444;s:41:"./application/seller/new/public\left.html";i:1517208469;s:41:"./application/seller/new/public\foot.html";i:1525943636;}*/ ?>
<!doctype html>
<html>
<head>
<meta charset="utf-8">
...
<table border="0" cellpadding="0" cellspacing="0" class="store-joinin">
    ...
    <tr>
        <th>公司所在地：</th>
        <td><?php echo $apply['company_site']; ?></td>
        <th>公司详细地址：</th>
...
<table border="0" cellpadding="0" cellspacing="0" class="store-joinin">
    ...
    <tr>
        ...
        <td><a href="<?php echo $apply['business_licence_cert']; ?>" target="_blank"><img src="<?php echo $apply['business_licence_cert']; ?>" height="60"></a></td>
    </tr>
    <!-- 
    <tr>
        <th>税务登记证复印件：</th>
    ...
    <tr>
        ...
        <tr>
        <th>法人身份证:</th>
        <td><a href="<?php echo $apply['legal_identity_cert']; ?>" target="_blank"><img src="<?php echo $apply['legal_identity_cert']; ?>" height="60"></a></td>
        </tr>
        -->
        <tr>
        <th>店铺负责人身份证:</th>
        <td><a href="<?php echo $apply['store_person_cert']; ?>" target="_blank"><img src="<?php echo $apply['store_person_cert']; ?>" height="60"></a></td>
        </tr>
    </tbody>
</table>
