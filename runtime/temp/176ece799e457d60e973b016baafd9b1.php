<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:42:"./application/admin/view2/admin\login.html";i:1517208468;}*/ ?>
<!doctype html>
...
<body>
                ...
                <div class="formContent">
                    ...
                    <div class="formInfo">
                       ...
                       <!--  <div class="formText">
                            ...
                            <img src="<?php echo $codepath; ?>" class="chicuele" id="imgVerify" alt="" onclick="fleshVerify()">
                        </div> -->
                        <div class="formText">
                        	<!--<div class="checkbox">-->
                            	<!--<div class="cur">
    ...
    <script type="text/javascript">
                ...
                if(vertify && $('#theForm input[name=username]').val() != '' && $('#theForm input[name=password]').val() != ''){
                    $.ajax({
                       ...
                       // url:'/index.php?m=Admin&c=Admin&a=login&t='+Math.random(),
                         url:'?m=Admin&c=Admin&a=login&t='+Math.random(),
        ...
        function fleshVerify(){
            $('#imgVerify').attr('src','?m=Admin&c=Admin&a=vertify&r='+Math.floor(Math.random()*100));//重载验证码
        }
    </script>
</body>
</html>
