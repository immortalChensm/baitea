...
return	array(	
	'system'=>array('name'=>'平台','child'=>array(
				...
				array('name' => '文章','child'=>array(
						...
						array('name' => '反馈列表', 'act'=>'lists', 'op'=>'Feedback'),
	...
	'shop'=>array('name'=>'商城','child'=>array(
				array('name' => '商品','child' => array(
				    ...
				    array('name' => '拍卖专场', 'act'=>'auctionList', 'op'=>'Goods'),
				    array('name' => '拍品竞拍列表', 'act'=>'auctionCompetitionList', 'op'=>'Goods'),
			)),
			...
			array('name' => '商家','child'=>array(
			    ...
			    array('name' => '主播列表', 'act'=>'livelist', 'op'=>'Live'),
			)),
			array('name' => '订单','child'=>array(
			    ...
			    array('name' => '竞拍列表', 'act'=>'index', 'op'=>'Auction'),
