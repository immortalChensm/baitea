...
return [
    ...
    'cache'                  => [
        ...
        'path'   => CACHE_PATH,
        // 缓存前缀
        'prefix' => '8914234cc151a37bd1178065ad57b91c',
        // 缓存有效期 0表示永久缓存
        'expire' => 0,
    ],
    /*
...
*/
   ...
   // 'APP_TOKEN_TIME' => 60 * 60 * 24 * 1000 * 30, //App保持token时间 , 此处为1天
    'APP_TOKEN_TIME' =>60*60*2,

    'INVITE_CODE_LENGTH'=>'4',
    
    //高德地图距离测算
    'GAODE_DISTANCE_KEY'=>'799f03f34112563cc99175056c5a78ac',
    
    'PRIVILEGE' => array(
        'admin' => array('system'=>'系统设置','content'=>'内容管理','goods'=>'商品中心','member'=>'会员中心',
            'order'=>'订单中心','marketing'=>'营销推广','tools'=>'插件工具','count'=>'统计报表',
            'weixin'=>'微信管理','store'=>'店铺管理','distribut'=>'分销管理','maintenance'=>'运营'
        ),
        'seller' => array('goods'=>'商品管理','order'=>'订单物流','promtion'=>'促销管理','store'=>'店铺管理',
