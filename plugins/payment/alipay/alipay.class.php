...
{    
    ...
    public function payment_refund($data){
    	...
    	$parameter = array(
    			...
    			"notify_url" => SITE_URL.U('Home/Payment/refundBackNew',array('pay_code'=>'alipay')),
    ...
    // 退款原路回调
    public function  refund_respose_new(){
        ...
        if($verify_result){
            ...
            if(intval($success_num)>0)
            {
                ...
                if($res[2] == 'SUCCESS'){
                    ...
                    file_put_contents("alipay_refund.txt", json_encode($_POST,JSON_UNESCAPED_UNICODE));
                }
            }
            echo "success"; //告诉支付宝处理成功
        }else{
